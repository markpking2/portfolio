  ...
  return (
    <ProjectContainer>
      ...
      <P>
        ...
        This website was developed using GatsbyJS; an awesome framework based on
        React used to build progessive web apps!
      </P>

      <LinkDiv>
        <a href="https://www.markpking2.com/lighthouse/">
