...
export default ({ children, widthoverride }) => {
  ...
  function colorChange() {
    ...
    tertiary =
      theme.colors[
        theme.colorIndex === 5 ? (theme.colorIndex = 0) : ++theme.colorIndex
      ];
          ...
          <Content>
            <Header>
              <NameWrapper>
                ...
                <SubheadingWrapper>
                  <Subheading>
                    Highly adaptable full stack engineer with a passion for
                    developing fast and scalable web applications.
                  </Subheading>
                </SubheadingWrapper>
              </NameWrapper>
              <Icons>
