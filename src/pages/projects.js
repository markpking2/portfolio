  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://markpking2.com/projects" />
        <meta
        ...
        <meta
          ...
          content="I'm Mark King, a full stack web developer. Here are some of the projects I've worked on."
        />
        <meta property="og:url" content="https://markpking2.com/projects" />
      </Helmet>
      <Layout>
        {viewedImage && (
          <ImageView setViewedImage={setViewedImage} image={viewedImage} />
        )}
        ...
        {projectList &&
          projectList.map((project, i) => {
            const images = projectImages
              ...
              .filter((image, i) => {
                return project.images.includes(image.node.relativePath);
              });
            return (
              <Project
                key={project.name}
                ...
                staticImages={projectStaticImages
                  .filter((node) =>
                    node.node.name.match(
                      new RegExp(`${project.imageQuery}`, "g")
                    )
                  )
...
export const query = graphql`
  query projectImages {
      ...
      edges {
        node {
          ...
          childImageSharp {
            fluid(
              maxWidth: 800
              srcSetBreakpoints: [200, 300, 400, 500, 600, 700, 800]
            ) {
    ...
    MobileProjectImages: allFile(
      ...
      edges {
        node {
          ...
          name
          childImageSharp {
            fluid(maxWidth: 400, srcSetBreakpoints: [100, 200, 300, 400]) {
              ...GatsbyImageSharpFluid_withWebp
            }
          }
        }
    ...
    LighthouseStill: file(relativePath: { regex: "/lighthouseStill.png/" }) {
      publicURL
    }
  }
`;
